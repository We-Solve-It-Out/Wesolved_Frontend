...
class QuoteDetailScreen extends StatelessWidget {
  ...
  const QuoteDetailScreen({super.key, required this.quote, required this.service});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: service.urlImagenServicio.isNotEmpty
            ? Image.network(service.urlImagenServicio, height: 200, width: 200, fit: BoxFit.cover,)
            : Icon(Iconsax.image, size: 200),
      )
