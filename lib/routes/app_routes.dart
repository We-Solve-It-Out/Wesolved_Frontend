...
import 'package:wesolve/features/authentication/screens/login/login.dart';
...
class AppRoutes {
  static final pages = [
    ...
    GetPage(name: TRoutes.quotes, page: () => const QuotesScreen()),
    GetPage(name: TRoutes.chats, page: () => const ChatsScreen()),
